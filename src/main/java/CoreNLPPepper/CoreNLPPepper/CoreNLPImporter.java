 ...
 * @author Okinina
 */
@Component(name = "CoreNLPImporterComponent", factory = "PepperImporterComponentFactory")
public class CoreNLPImporter extends PepperImporterImpl implements PepperImporter{
	/** this is a logger, for recording messages during program process, like debug messages**/
	private static final Logger logger = LoggerFactory.getLogger(CoreNLPImporter.class);
	 ...
	 * module unique.
	 */
	public CoreNLPImporter() {
		super();
		setName("CoreNLPImporter");
	 ...
	 * sample mapper of type {@link CoreNLPMapper}, which only produces a fixed
	 * document-structure in method {@link CoreNLPMapper#mapSDocument()} and
	 * enhances the corpora for further meta-annotations in the method
	 * {@link CoreNLPMapper#mapSCorpus()}. <br/>
	 ...
	 * {@link CoreNLPMapper#mapSDocument()} and enhances the corpora for further
	 * meta-annotations in the method {@link CoreNLPMapper#mapSCorpus()}. <br/>
	 ...
	 *
	 */
	public static class CoreNLPMapper extends PepperMapperImpl {
		/**
		 * <strong>OVERRIDE THIS METHOD FOR CUSTOMIZATION</strong> <br/>
