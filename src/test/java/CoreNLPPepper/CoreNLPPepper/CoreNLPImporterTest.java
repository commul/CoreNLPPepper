...
import CoreNLPPepper.CoreNLPPepper.CoreNLPImporter;
 ...
 * {@link CoreNLPImporter} class. Feel free to adapt and enhance this test class
 ...
 * @author Okinina
 */
public class CoreNLPImporterTest extends PepperImporterTest {
	/**
	...
	@Before
	public void setUp() {
		setFixture(new CoreNLPImporter());
	...
	public void test_DummyImplementation() {
		...
		getFixture().getCorpusDesc().setCorpusPath(getTempURI("CoreNLPImporter"));
