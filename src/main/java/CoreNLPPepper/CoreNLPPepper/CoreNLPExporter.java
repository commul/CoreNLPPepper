 ...
 */
//@formatter:off
@Component(name = "CoreNLPExporterComponent", factory = "PepperExporterComponentFactory")
//@formatter:on
public class CoreNLPExporter extends PepperExporterImpl implements PepperExporter {
	// =================================================== mandatory
	// ===================================================
	/**
	 ...
	 * module unique.
	 */
	public CoreNLPExporter() {
		super();
		setName("CoreNLPExporter");
	 ...
	 * In this dummy implementation an instance of {@link CoreNLPMapper} is
	 * created and its location to where the document-structure should be
	 * exported to is set.
	 */
	@Override
	public PepperMapper createPepperMapper(Identifier Identifier) {
		PepperMapper mapper = new CoreNLPMapper();
