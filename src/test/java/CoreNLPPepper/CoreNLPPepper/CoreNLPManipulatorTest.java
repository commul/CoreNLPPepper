...
import CoreNLPPepper.CoreNLPPepper.CoreNLPManipulator;
 ...
 * {@link CoreNLPManipulator} class. Feel free to adapt and enhance this test
 ...
 * @author Okinina
 */
public class CoreNLPManipulatorTest extends PepperManipulatorTest {
	/**
	...
	@Before
	public void setUp() {
		setFixture(new CoreNLPManipulator());
	}
